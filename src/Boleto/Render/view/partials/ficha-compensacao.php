<table class="table-boleto" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td valign="bottom" colspan="8" class="noborder nopadding">
            <div class="logocontainer">
                <div class="logobanco">
                    <img src="<?php echo  isset($logo_banco_base64) && !empty($logo_banco_base64) ? $logo_banco_base64 : 'https://dummyimage.com/150x75/fff/000000.jpg&text=+' ?>" alt="logo do banco">
                </div>
    ...
    <tr class="<?php if($mostrar_endereco_ficha_compensacao):?> duas-linhas <?php endif?>">
        <td colspan="7">
            ...
            <?php if($mostrar_endereco_ficha_compensacao):?><div class="conteudo"><?php echo  $beneficiario['endereco_completo'] ?></div><?php endif?>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <div class="titulo">(+) Mora / Multa <?php echo  $codigo_banco == '104' ? '/ Juros' : '' ?></div>
            <div class="conteudo rtl"></div>
        </td>
    </tr>
    <tr>
